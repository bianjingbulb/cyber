...
class PrefecturesControllerTest < ActionController::TestCase
  ...
  test "should create prefecture" do
    assert_difference('Prefecture.count') do
      post :create, prefecture: { capital: @prefecture.capital, capital_ruby: @prefecture.capital_ruby, prefecture: @prefecture.prefecture, prefecture_ruby: @prefecture.prefecture_ruby }
    end
  ...
  test "should update prefecture" do
    patch :update, id: @prefecture, prefecture: { capital: @prefecture.capital, capital_ruby: @prefecture.capital_ruby, prefecture: @prefecture.prefecture, prefecture_ruby: @prefecture.prefecture_ruby }
    assert_redirected_to prefecture_path(assigns(:prefecture))
  end
